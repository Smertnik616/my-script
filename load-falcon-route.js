...
(async () => {
    const urls = [
        'https://raw.githubusercontent.com/Smertnik616/my-script/6b45178/falcon-route.js?t=' + Date.now(),
        'https://cdn.jsdelivr.net/gh/Smertnik616/my-script@6b45178/falcon-route.js?t=' + Date.now()
    ];
