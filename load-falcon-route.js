...
(async () => {
    const urls = [
        'https://raw.githubusercontent.com/Smertnik616/my-script/d79a040/falcon-route.js?t=' + Date.now(),
        'https://cdn.jsdelivr.net/gh/Smertnik616/my-script@d79a040/falcon-route.js?t=' + Date.now()
    ];
