// ══════════════════════════════════════════════
// FALCONROUTE v2 — встав ВЕСЬ цей файл у консоль карти
// Версія: embedded (без CDN). У заголовку має бути: FALCONROUTE v2 (Збиття)
// Якщо бачиш «POI & Radius» або кнопку «Очистити все» — вставлено НЕ цей файл
// ══════════════════════════════════════════════
document.getElementById('falcon-route-ui')?.remove();
document.getElementById('falcon-route-tip')?.remove();
console.log('🦅 FalconRoute v2 EMBEDDED — paste OK');
