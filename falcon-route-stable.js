(function () {
    ...
    // SNAPSHOT: заморожена стара версія FalconRoute (aim-label-h-23).
    // Для експериментів змінюй falcon-route.js — цей файл не чіпай.
    ...
    const FR_BUILD = 'stable-aim-label-h-23';
